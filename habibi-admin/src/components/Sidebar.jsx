...
import {
  ...
  Bookmark, Share2, Users2, Layers, QrCode,
} from 'lucide-react';
...
const NAV = [
  ...
  { to: '/tables',        icon: <QrCode size={17} />,       label: 'Table Manager' },
  ...
  { to: '/payment-processors', icon: <CreditCard size={17} />, label: 'Payment Processors' },
