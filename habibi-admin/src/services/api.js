...
export const adminAPI = {
  ...
  uploadBroadcastImage: (fd) => upload('/api/admin/broadcasts/upload-image', fd),
  ...
  bulkImportDrivers:  (drivers)   => req('/api/dispatch/drivers/bulk-import', { method: 'POST', body: JSON.stringify({ drivers }) }),
  ...
  getDriverChat:     (driver_id)       => req(`/api/dispatch/driver/${driver_id}/chat`),
  replyToDriver:     (driver_id, msg)  => req(`/api/dispatch/driver/${driver_id}/chat/reply`, { method: 'POST', body: JSON.stringify({ message: msg }) }),
...
export const loyaltyAPI = {
  ...
  getTiers:      ()                              => req('/api/admin/loyalty/tiers'),
  updateTiers:   (tiers)                          => req('/api/admin/loyalty/tiers', { method: 'PUT', body: JSON.stringify({ tiers }) }),
};
