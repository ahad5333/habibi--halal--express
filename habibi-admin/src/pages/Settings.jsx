...
const SITE_FIELDS = [
  ...
  { key: 'email_customer_service', label: 'Customer Service Email', placeholder: 'habibi@habibihe.com', type: 'email' },
  { key: 'email_urgent', label: 'Urgent Matters Email', placeholder: 'urgent@habibihe.com', type: 'email' },
  { key: 'email_wholesale', label: 'Wholesale Accounts Email', placeholder: 'merchant@habibihe.com', type: 'email' },
  { key: 'email_media', label: 'Media Inquiries Email', placeholder: 'media@habibihe.com', type: 'email' },
