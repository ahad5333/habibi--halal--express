      ...
      <div className="footer-container">
        <div className="footer-brand">
          ...
          <div className="social-icons mt-4">
            ...
            <a href={settings.social_facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" title="Facebook" className="social-fb">
            ...
            <a href={settings.social_instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" title="Instagram" className="social-ig">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
            ...
            <a href={settings.social_tiktok} target="_blank" rel="noopener noreferrer" aria-label="TikTok" title="TikTok" className="social-tt">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
          ...
          <div className="footer-qr-row">
            {[
              { label: 'Facebook',  src: '/images/qr/qr-facebook.svg',  href: settings.social_facebook  || 'https://facebook.com/habibihalalexpress' },
              { label: 'Instagram', src: '/images/qr/qr-instagram.svg', href: settings.social_instagram || 'https://instagram.com/habibihalalexpress' },
