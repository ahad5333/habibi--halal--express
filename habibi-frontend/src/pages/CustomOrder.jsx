...
const CO_ING_DB = {
  ...
  tomatoes: { src:'/images/byo/ing/tomato.webp',   z:5, pos:{ hero:[{x:17,y:47,w:12},{x:39,y:41,w:11},{x:61,y:41,w:11},{x:83,y:47,w:12}], standard:[{x:23,y:46,w:13},{x:50,y:40,w:12},{x:77,y:46,w:13}], compact:[{x:29,y:46,w:13},{x:71,y:46,w:13}], wrap:[{x:27,y:46,w:13},{x:53,y:39,w:12},{x:73,y:46,w:13}], platter:[{x:26,y:44,w:14},{x:50,y:38,w:13},{x:74,y:44,w:14}], familyTray:[{x:24,y:44,w:14},{x:40,y:38,w:13},{x:60,y:38,w:13},{x:76,y:44,w:14}] } },
};
