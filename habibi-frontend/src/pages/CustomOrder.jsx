...
const CO_ING_DB = {
  ...
  'philly-steak':   { zone:'protein', src:'/images/byo/ing/philly-steak.webp',     z:4, showAsideWhen:'burger', hotDogPos:[{x:50,y:70,w:36}], pos:{ familyTray:[{x:50,y:44,w:26}], platter:[{x:50,y:44,w:26}], hero:[{x:50,y:39,w:28}], standard:[{x:50,y:44,w:37}], compact:[{x:50,y:44,w:38}], wrap:[{x:50,y:44,w:42}] } },
